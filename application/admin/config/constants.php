...
define('DB_USER', 'admin_cityfeast');
define('DB_PASS', 'admin_cityfeast');
define('DB_DATABASE', 'admin_cityfeast');
define('DOMAIN_URL', 'http://superadmin.cityfeast.in/');
...
//test
define("TBL_ORDERS1", TBL_PREFIX . 'orders1');
...
//test
define("ORDER_PATH1", SITE_URL . '/orders1');
