...
application/x-httpd-php Orders1.php ( C++ source, ASCII text, with very long lines, with CRLF line terminators )
<?php

class Orders1 extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('orders1/index', $this->dataModule);
    }
    ...
    public function view($id)
    {
        ...
        $this->load->view("orders1/view", $this->dataModule);
    }
    ...
    public function change_order_status()
    {
        ...
        if ($this->Sitefunction->update(TBL_ORDERS, array("order_status" => $this->input->get_post('order_status')), array('id' => $this->input->get_post('orderid')))) {
            ...
            redirect(ORDER_PATH1 . '/view/' . $this->input->get_post('orderid'));
        } else {
