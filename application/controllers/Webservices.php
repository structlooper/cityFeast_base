...
//      Commented on 25 Nov 2020 $this->input->raw_input_stream is not getting request
		...
		//$get_user = $this->Common_model->get_single_row(TBL_USERS, 'status, id', array('email' => 'anubhavanand884%40gmail.com', 'password' => md5($password), 'status!=' => 2));
